...
while($balance1 >= $monthly_payment1){
  ...
  $amortization_obj->monthly_payment = $monthly_payment + $amountAdditionalMonthly;
  // total amount extra payment
...
$extrapayment_total_paid = $total_paid_with_extra_payment;
$extrapayment_months = $extra_payment_months;
$extrapayment_monthly_payment =  $monthly_payment + $amountAdditionalMonthly;
...
$extrapaymentObj->extrapayment_months = $extrapayment_months;
...
$extrapaymentObj->monthly_payment = $monthly_payment;
